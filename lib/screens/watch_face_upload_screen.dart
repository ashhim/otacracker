    ...
    return AppShell(
      ...
      child: ListView(
        children: [
                      ...
                      children: [
                        Expanded(
                          child: ClipRRect(
                            ...
                            child: Image.memory(asset.optimizedBytes, fit: BoxFit.cover),
                          ),
                        ),
          ...
          if (watch.assets.isNotEmpty) const SizedBox(height: 14),
          if (watch.assets.isNotEmpty)
            NeonCard(
              child: Row(
                children: [
                  ElevatedButton.icon(
                    onPressed: () => ref.read(watchFaceControllerProvider).buildPackage(_nameController.text.trim()),
